...
void DrawCar(CAR *car)
{
     ...
     tou[1] = y - A * 8.6 * sin(54.5 * P / 180 + a);
     tou[2] = x + A * 10.3 * cos(60.9 * P / 180 + a);
     tou[3] = y - A * 10.3 * sin(60.9 * P / 180 + a);
     tou[4] = x + A * 9.49 * cos(71.5 * P / 180 + a);
     tou[5] = y - A * 9.49 * sin(71.5 * P / 180 + a);
     tou[6] = x + A * 12.37 * cos(75.95 * P / 180 + a);
     tou[7] = y - A * 12.37 * sin(75.95 * P / 180 + a);
     tou[8] = x - A * 12.37 * cos(75.95 * P / 180 - a);
     tou[9] = y - A * 12.37 * sin(75.95 * P / 180 - a);
     tou[10] = x - A * 9.49 * cos(71.5 * P / 180 - a);
     tou[11] = y - A * 9.49 * sin(71.5 * P / 180 - a);
     tou[12] = x - A * 10.3 * cos(60.9 * P / 180 - a);
     tou[13] = y - A * 10.3 * sin(60.9 * P / 180 - a);
     tou[14] = x - A * 8.6 * cos(54.5 * P / 180 - a);
     tou[15] = y - A * 8.6 * sin(54.5 * P / 180 - a);

     //车尾
     wei[0] = x + A * 11.18 * cos(63.44 * P / 180 - a);
     wei[1] = y + A * 11.18 * sin(63.44 * P / 180 - a);
     wei[2] = x + A * 12.08 * cos(65.556 * P / 180 - a);
     wei[3] = y + A * 12.08 * sin(65.556 * P / 180 - a);
     wei[4] = x + A * 11.4 * cos(74.777 * P / 180 - a);
     wei[5] = y + A * 11.4 * sin(74.777 * P / 180 - a);
     wei[6] = x + A * 13.34 * cos(77.036 * P / 180 - a);
     wei[7] = y + A * 13.34 * sin(77.036 * P / 180 - a);
     wei[8] = x - A * 13.34 * cos(77.036 * P / 180 + a);
     wei[9] = y + A * 13.34 * sin(77.036 * P / 180 + a);
     wei[10] = x - A * 11.4 * cos(74.777 * P / 180 + a);
     wei[11] = y + A * 11.4 * sin(74.777 * P / 180 + a);
     wei[12] = x - A * 12.08 * cos(65.556 * P / 180 + a);
     wei[13] = y + A * 12.08 * sin(65.556 * P / 180 + a);
     wei[14] = x - A * 11.18 * cos(63.44 * P / 180 + a);
     wei[15] = y + A * 11.18 * sin(63.44 * P / 180 + a);

     //车窗矩形
     ch[0] = x + A * 8.6 * cos(54.5 * P / 180 + a);
     ch[1] = y - A * 8.6 * sin(54.5 * P / 180 + a);
     ch[2] = x - A * 8.6 * cos(54.5 * P / 180 - a);
     ch[3] = y - A * 8.6 * sin(54.5 * P / 180 - a);
     ch[4] = x - A * 11.18 * cos(63.44 * P / 180 + a);
     ch[5] = y + A * 11.18 * sin(63.44 * P / 180 + a);
     ch[6] = x + A * 11.18 * cos(63.44 * P / 180 - a);
     ch[7] = y + A * 11.18 * sin(63.44 * P / 180 - a);

     //车顶矩形
     ding[0] = x + A * 3.606 * cos(33.69 * P / 180 + a);
     ding[1] = y - A * 3.606 * sin(33.69 * P / 180 + a);
     ding[2] = x - A * 3.606 * cos(33.69 * P / 180 - a);
     ding[3] = y - A * 3.606 * sin(33.69 * P / 180 - a);
     ding[4] = x - A * 8.544 * cos(69.444 * P / 180 + a);
     ding[5] = y + A * 8.544 * sin(69.444 * P / 180 + a);
     ding[6] = x + A * 8.544 * cos(69.444 * P / 180 - a);
     ding[7] = y + A * 8.544 * sin(69.444 * P / 180 - a);

     //前车灯三角形
     d1[0] = x + A * 10.3 * cos(60.9 * P / 180 + a);
     d1[1] = y - A * 10.3 * sin(60.9 * P / 180 + a);
     d1[2] = x + A * 9.49 * cos(71.5 * P / 180 + a);
     d1[3] = y - A * 9.49 * sin(71.5 * P / 180 + a);
     d1[4] = x + A * 12.37 * cos(75.95 * P / 180 + a);
     d1[5] = y - A * 12.37 * sin(75.95 * P / 180 + a);

     //前车灯三角形
     d2[0] = x - A * 12.37 * cos(75.95 * P / 180 - a);
     d2[1] = y - A * 12.37 * sin(75.95 * P / 180 - a);
     d2[2] = x - A * 9.49 * cos(71.5 * P / 180 - a);
     d2[3] = y - A * 9.49 * sin(71.5 * P / 180 - a);
     d2[4] = x - A * 10.3 * cos(60.9 * P / 180 - a);
     d2[5] = y - A * 10.3 * sin(60.9 * P / 180 - a);

     //后车灯三角形
     d3[0] = x + A * 12.08 * cos(65.556 * P / 180 - a);
     d3[1] = y + A * 12.08 * sin(65.556 * P / 180 - a);
     d3[2] = x + A * 11.4 * cos(74.777 * P / 180 - a);
     d3[3] = y + A * 11.4 * sin(74.777 * P / 180 - a);
     d3[4] = x + A * 13.34 * cos(77.036 * P / 180 - a);
     d3[5] = y + A * 13.34 * sin(77.036 * P / 180 - a);

     //后车灯三角形
     d4[0] = x - A * 13.34 * cos(77.036 * P / 180 + a);
     d4[1] = y + A * 13.34 * sin(77.036 * P / 180 + a);
     d4[2] = x - A * 11.4 * cos(74.777 * P / 180 + a);
     d4[3] = y + A * 11.4 * sin(74.777 * P / 180 + a);
     d4[4] = x - A * 12.08 * cos(65.556 * P / 180 + a);
     d4[5] = y + A * 12.08 * sin(65.556 * P / 180 + a);
